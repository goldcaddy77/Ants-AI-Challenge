...
public abstract class AStar<T>
{
    ...
    /**
     * Total cost function for to -> from
     * f(x) = g(x) + h(x)
     */
    ...
    private void expand(Path path){
        ...
        // If better path already exists then don't expand
    ...
    public List<T> compute(T start){
        try{
            ...
            f(root, start, start); // needed if the initial point has a cost
